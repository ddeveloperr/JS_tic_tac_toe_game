function MenuState(name) {
	...
	btns.push(new MenuButton("Open source code", 20, _yPos+210, function() {
		window.open("https://github.com/ddeveloperr");
	}));
...
function AboutState(name) {
	...
	var text = "Tic Tac Toe is a game for two players, X and O, who take turns marking the spaces in a 3×3 grid. The player who succeeds in placing three respective marks in a horizontal, vertical, or diagonal row WINS the game! Cool ha?";
	var hastick = false;
